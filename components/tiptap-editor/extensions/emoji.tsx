...
export const EmojiPicker = ({ editor }: { editor: any }) => {
    ...
    return (
        <div className='w-[320px] rounded-md border bg-white p-2 shadow-md'>
            <Input
                            ...
                            <ScrollArea className='h-[200px]'>
                                <div className='grid grid-cols-8 gap-1'>
                                    {category.emojis.map((emoji, index) => (
                                        <button
                                            key={index}
                                            className='flex size-8 cursor-pointer items-center justify-center rounded text-xl hover:bg-gray-100'
